...
func getEmbeddedPostgresDataDir(b *benchmark.Benchmark) string {
	...
	if _, err := os.Stat(dir); os.IsNotExist(err) {
		b.Log(benchmark.LogInfo, 0, fmt.Sprintf("Creating Embedded Postgres data dir: %s", dir))
	...
	b.Log(benchmark.LogInfo, 0, fmt.Sprintf("Using Embedded Postgres data dir: %s", dir))
